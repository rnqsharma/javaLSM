...
public final class LSMEntrySerializer implements EntrySerializer<LSMEntry> {

    public static final LSMEntrySerializer INSTANCE = new LSMEntrySerializer();

    private LSMEntrySerializer() {
    }
     ...
     */
    @Override
    public byte[] marshall(LSMEntry entry) throws IOException {
    ...
    @Override
    public LSMEntry unmarshall(byte[] data) {
